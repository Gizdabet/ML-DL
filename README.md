# Redictive Model For Customers' Savings Account Openings Using Machine Learning (K-Nearest Neighbor, Support Vector Machine ) And Deep Learning (Artificial Neutral Network).
